...
define gui.accent_color = u'#4e2e05'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = u'#1b1b1b'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = u'#202020'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = u'#695038'
...
define gui.insensitive_color = u'#1d12127f'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = u'#53423b'
define gui.hover_muted_color = u'#4e4233'
...
define gui.name_text_font = "Harting_plain.ttf"
...
define gui.main_menu_background = Image("images/showstage.png",oversample=1.5)
define gui.game_menu_background = Image("images/showstage.png",oversample=1.5)
...
define gui.choice_button_text_idle_color = "#353535"
